...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    ...
    getData: function getData() {
      ...
      axios.get('https://devinfinity.holomia.com/api/v1/player/show/5').then(function (response) {
        console.log(response); // console.log(response.data.entries[1].Description);
