<template>
    <div v-if="current_group">
        <div class="modal fade" id="OpenGroupAppTimeModal" tabindex="-1" role="dialog" aria-labelledby="openAppModalLabel"
            aria-hidden="true" style="padding-right:0px">
            <div class="modal-dialog" role="document">
                <div class="modal-content overflow-auto" style="height: 70vh;">
                    <div class="modal-header">
                        <h5 class="modal-title" id="OpenGroupAppTimeModal">Launch App</h5>
        ...
        <div class="modal fade" id="openNotificationTimeGroup" tabindex="-1" role="dialog"
            aria-labelledby="openNotificationLabel" aria-hidden="true" style="width: 100%;padding-right: 0;">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="openNotificationTimeGroup">Launch App</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close" @click="close()">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <form @submit.prevent="lauchApp">
                            <div class="bg-blue-100 rounded-lg py-5 px-6 mb-3 tex-xl text-blue-700 inline-flex items-center w-full"
                              ...
                              <p class="ml-2">Are you want to run app &nbsp; <strong>{{ form.appName }}</strong>&nbsp; for all device
                                in &nbsp; <strong> {{ current_group.name }}</strong>&nbsp; group</p>  
