<template>
    <div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <ul class="flex flex-col  p-4" v-for="(app, index) in applications" :key="index">
        ...
        <div class="modal fade" id="openNotification" tabindex="-1" role="dialog"
            aria-labelledby="openNotificationLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form @submit.prevent="lauchApp">
                            <div class="bg-blue-100 rounded-lg py-5 px-6 mb-3 tex-xl text-blue-700 inline-flex items-center w-full"
                              ...
                              Are you want to run app &nbsp; <strong>{{form.appName}}</strong>&nbsp;  for {{ids.length}} devices ?
                            </div>
