...
var options = {
    key: fs.readFileSync('/etc/letsencrypt/live/devstartup.holomia.com/privkey.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/devstartup.holomia.com/fullchain.pem')
};
